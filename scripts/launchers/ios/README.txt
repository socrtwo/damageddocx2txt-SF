Damaged DOCX to Text — iOS / iPadOS
===================================

How to install (recommended)
----------------------------
This tool installs from Safari as a Progressive Web App.

1. Open Safari on your iPhone/iPad.
2. Visit:  https://socrtwo.github.io/damageddocx2txt-SF/
...
Privacy
-------
Your .docx file never leaves your device; all processing happens locally
in Safari.
